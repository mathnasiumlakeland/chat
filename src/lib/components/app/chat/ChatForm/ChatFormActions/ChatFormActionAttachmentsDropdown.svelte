<script lang="ts">
	...
	const menuItemTooltipClass =
		'pointer-events-none select-none data-[state=closed]:animate-none data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-100';
</script>
			...
			<DropdownMenu.Content align="start" class="w-48">
				...
				{:else}
					<Tooltip.Root>
						...
						<Tooltip.Content side="right" sideOffset={10} class={menuItemTooltipClass}>
